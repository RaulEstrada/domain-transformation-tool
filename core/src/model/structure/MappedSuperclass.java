...
public class MappedSuperclass implements EntityWithLifeCycle {
    ...
    @XmlTransient
    private String mappedSuperclassContent;
	...
	public String getMappedSuperclassContent() {
		return mappedSuperclassContent;
	}

	public void setMappedSuperclassContent(String mappedSuperclassContent) {
		this.mappedSuperclassContent = mappedSuperclassContent;
	}
