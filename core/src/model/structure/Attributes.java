...
public class Attributes implements AnnotatedAttributes {
	...
	public String toString() {
		return "Attributes [description=" + description + ", \n\tid=" + id + ", embeddedId=" + embeddedId + ", \n\tbasic="
				+ basic + ", version=" + version + ", manyToOne=" + manyToOne + ", oneToMany=" + oneToMany
				+ ", oneToOne=" + oneToOne + ", manyToMany=" + manyToMany + ", elementCollection=" + elementCollection
				+ ", embedded=" + embedded + ", _transient=" + _transient + "]";
	}
