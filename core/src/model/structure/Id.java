...
public class Id {
    ...
    @XmlTransient
    private ManyToOne primaryKeyJoinColumnParentEntity;
	...
	public ManyToOne getPrimaryKeyJoinColumnParentEntity() {
		return primaryKeyJoinColumnParentEntity;
	}

	public void setPrimaryKeyJoinColumnParentEntity(ManyToOne primaryKeyJoinColumnParentEntity) {
		this.primaryKeyJoinColumnParentEntity = primaryKeyJoinColumnParentEntity;
	}

	@Override
	public String toString() {
		return "Id [column=" + column + ", generatedValue=" + generatedValue + ", temporal=" + temporal
				+ ", tableGenerator=" + tableGenerator + ", sequenceGenerator=" + sequenceGenerator + ", name=" + name
