...
public class OneToMany {
	...
	public String toString() {
		return "OneToMany [orderBy=" + orderBy + ", orderColumn=" + orderColumn + ", mapKey=" + mapKey
				+ ", mapKeyClass=" + mapKeyClass + ", mapKeyTemporal=" + mapKeyTemporal + ", mapKeyEnumerated="
				+ mapKeyEnumerated + ", mapKeyAttributeOverride=" + mapKeyAttributeOverride + ", mapKeyConvert="
				+ mapKeyConvert + ", mapKeyColumn=" + mapKeyColumn + ", mapKeyJoinColumn=" + mapKeyJoinColumn
				+ ", mapKeyForeignKey=" + mapKeyForeignKey + ", joinTable=" + joinTable + ", joinColumn=" + joinColumn
				+ ", foreignKey=" + foreignKey + ", cascade=" + cascade + ", name=" + name + ", targetEntity="
				+ targetEntity + ", fetch=" + fetch + ", access=" + access + ", mappedBy=" + mappedBy
