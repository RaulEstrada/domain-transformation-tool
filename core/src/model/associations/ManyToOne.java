...
public class ManyToOne {
	...
	public String toString() {
		return "ManyToOne [joinColumn=" + joinColumn + ", foreignKey=" + foreignKey + ", joinTable=" + joinTable
				+ ", cascade=" + cascade + ", name=" + name + ", targetEntity=" + targetEntity + ", fetch=" + fetch
				+ ", optional=" + optional + ", access=" + access + ", mapsId=" + mapsId + ", id=" + id + "]";
	}
