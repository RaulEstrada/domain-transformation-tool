...
import org.xtext.example.tfg.jvmmodel.MyDslJvmModelInferrer;
import org.xtext.example.tfg.parser.antlr.MyDslAntlrTokenFileProvider;
import org.xtext.example.tfg.parser.antlr.MyDslParser;
import org.xtext.example.tfg.parser.antlr.internal.InternalMyDslLexer;
import org.xtext.example.tfg.scoping.MyDslScopeProvider;
import org.xtext.example.tfg.serializer.MyDslSemanticSequencer;
import org.xtext.example.tfg.serializer.MyDslSyntacticSequencer;
import org.xtext.example.tfg.services.MyDslGrammarAccess;
import org.xtext.example.tfg.validation.MyDslValidator;
...
public abstract class AbstractMyDslRuntimeModule extends DefaultXbaseRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "org/xtext/example/tfg/MyDsl.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("org.xtext.example.tfg.MyDsl");
	}
	
	public void configureFileExtensions(Binder binder) {
		if (properties == null || properties.getProperty(Constants.FILE_EXTENSIONS) == null)
			binder.bind(String.class).annotatedWith(Names.named(Constants.FILE_EXTENSIONS)).toInstance("tfg");
	}
