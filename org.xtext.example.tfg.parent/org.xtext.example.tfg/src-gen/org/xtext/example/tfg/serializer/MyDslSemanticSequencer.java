 ...
 */
package org.xtext.example.tfg.serializer;
...
public class MyDslSemanticSequencer extends XbaseSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == MyDslPackage.eINSTANCE)
			...
			case MyDslPackage.ANNOTATED_ATTRIBUTE:
				sequence_ANNOTATED_ATTRIBUTE(context, (ANNOTATED_ATTRIBUTE) semanticObject); 
				return; 
	...
	/**
	 * Contexts:
	 *     ENTITYELEMENT returns ANNOTATED_ATTRIBUTE
	 *     ANNOTATED_ATTRIBUTE returns ANNOTATED_ATTRIBUTE
	 *
	 * Constraint:
	 *     ((annotation='@Id' | annotation='@Version')? type=JvmTypeReference name=ID)
	 */
	protected void sequence_ANNOTATED_ATTRIBUTE(ISerializationContext context, ANNOTATED_ATTRIBUTE semanticObject) {
	...
	protected void sequence_ATTRIBUTE(ISerializationContext context, ATTRIBUTE semanticObject) {
		...
		feeder.accept(grammarAccess.getATTRIBUTEAccess().getTypeJvmTypeReferenceParserRuleCall_0_0(), semanticObject.getType());
	 ...
	 *
	 * Constraint:
	 *     (abstractEntity?='abstract'? name=ID parent=[ENTITY|ID]? entityElements+=ENTITYELEMENT*)
	 */
	 ...
	 *
	 * Constraint:
	 *     (name=ID relations+=RELATIONSHIP* attributes+=ATTRIBUTE*)
	 */
	...
	/**
	 * Contexts:
	 *     ENTITYELEMENT returns OPERATION
	 *     OPERATION returns OPERATION
	 *
	 * Constraint:
	 *     (return=JvmTypeReference name=ValidID (params+=FullJvmFormalParameter params+=FullJvmFormalParameter*)?)
	 */
	 ...
	 *
	 * Constraint:
	 *     ((cardinal='ZeroOne' | cardinal='One' | cardinal='Many' | cardinal='OneMany') type=[ENTITY|ID] name=ID)
	 */
	 ...
	 *
	 * Constraint:
	 *     (name=ValidID valueattributes+=ATTRIBUTE*)
	 */
