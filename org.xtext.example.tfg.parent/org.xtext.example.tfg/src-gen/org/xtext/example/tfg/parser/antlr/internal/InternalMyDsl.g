...
@after {
	...
	(
		...
		{
			$current = $this_VALUEOBJECT_1.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
...
@after {
	...
	(
		...
		(
			(
				lv_abstractEntity_1_0='abstract'
				{
...
@after {
	...
	(
		...
		{
			$current = $this_ANNOTATED_ATTRIBUTE_0.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
...
entryRuleANNOTATED_ATTRIBUTE returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getANNOTATED_ATTRIBUTERule()); }
	iv_ruleANNOTATED_ATTRIBUTE=ruleANNOTATED_ATTRIBUTE
	{ $current=$iv_ruleANNOTATED_ATTRIBUTE.current; }
	EOF;

// Rule ANNOTATED_ATTRIBUTE
ruleANNOTATED_ATTRIBUTE returns [EObject current=null]
@init {
	enterRule();
}
@after {
