 ...
 */
package org.xtext.example.tfg.ide.contentassist.antlr;
...
import org.xtext.example.tfg.ide.contentassist.antlr.internal.InternalMyDslParser;
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getENTITYELEMENTAccess().getAlternatives(), "rule__ENTITYELEMENT__Alternatives");
					put(grammarAccess.getANNOTATED_ATTRIBUTEAccess().getAnnotationAlternatives_0_0(), "rule__ANNOTATED_ATTRIBUTE__AnnotationAlternatives_0_0");
					put(grammarAccess.getRELATIONSHIPAccess().getCardinalAlternatives_0_0(), "rule__RELATIONSHIP__CardinalAlternatives_0_0");
					...
					put(grammarAccess.getANNOTATED_ATTRIBUTEAccess().getGroup(), "rule__ANNOTATED_ATTRIBUTE__Group__0");
					...
					put(grammarAccess.getENTITYAccess().getAbstractEntityAssignment_1(), "rule__ENTITY__AbstractEntityAssignment_1");
					...
					put(grammarAccess.getENTITYAccess().getEntityElementsAssignment_5(), "rule__ENTITY__EntityElementsAssignment_5");
					put(grammarAccess.getVALUEOBJECTAccess().getNameAssignment_1(), "rule__VALUEOBJECT__NameAssignment_1");
					put(grammarAccess.getVALUEOBJECTAccess().getValueattributesAssignment_3(), "rule__VALUEOBJECT__ValueattributesAssignment_3");
					put(grammarAccess.getENUMERATIONAccess().getNameAssignment_1(), "rule__ENUMERATION__NameAssignment_1");
					put(grammarAccess.getENUMERATIONAccess().getEnumelementsAssignment_3(), "rule__ENUMERATION__EnumelementsAssignment_3");
					put(grammarAccess.getLINKAccess().getNameAssignment_1(), "rule__LINK__NameAssignment_1");
					put(grammarAccess.getLINKAccess().getRelationsAssignment_3(), "rule__LINK__RelationsAssignment_3");
					put(grammarAccess.getLINKAccess().getAttributesAssignment_4(), "rule__LINK__AttributesAssignment_4");
					put(grammarAccess.getANNOTATED_ATTRIBUTEAccess().getAnnotationAssignment_0(), "rule__ANNOTATED_ATTRIBUTE__AnnotationAssignment_0");
					put(grammarAccess.getANNOTATED_ATTRIBUTEAccess().getTypeAssignment_1(), "rule__ANNOTATED_ATTRIBUTE__TypeAssignment_1");
					put(grammarAccess.getANNOTATED_ATTRIBUTEAccess().getNameAssignment_2(), "rule__ANNOTATED_ATTRIBUTE__NameAssignment_2");
					put(grammarAccess.getATTRIBUTEAccess().getTypeAssignment_0(), "rule__ATTRIBUTE__TypeAssignment_0");
					put(grammarAccess.getATTRIBUTEAccess().getNameAssignment_1(), "rule__ATTRIBUTE__NameAssignment_1");
					put(grammarAccess.getRELATIONSHIPAccess().getCardinalAssignment_0(), "rule__RELATIONSHIP__CardinalAssignment_0");
					...
					put(grammarAccess.getOPERATIONAccess().getReturnAssignment_1(), "rule__OPERATION__ReturnAssignment_1");
